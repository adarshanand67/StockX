import { stockExchange } from "../utils/companies";

export function stockExchangeOption(selectedStockExchange, handleExchangeChange, duration, handleDuration) {
  return (
    <div className="flex justify-center gap-5">
      <div className="w-1/3">
        <select
          ...
          value={selectedStockExchange}
          onChange={handleExchangeChange}
        >
          {/* <option value="">Select Company</option> */}
          {stockExchange.map((company) => (
